...
Blip_Buffer::blargg_err_t Blip_Buffer::set_sample_rate( long new_rate, int msec )
{
	...
	long long new_size = (ULONG_MAX >> BLIP_BUFFER_ACCURACY) - blip_buffer_extra_ - 64;
	if ( msec != blip_max_length )
	{
		long s = (new_rate * (msec + 1) + 999) / 1000;
		fprintf(stderr, "s=%ld, new_size=%ld\n", s, new_size);
		if ( s < new_size )
			new_size = s;
		else
...
blip_resampled_time_t Blip_Buffer::clock_rate_factor( double rate ) const
{
